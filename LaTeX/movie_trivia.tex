...
\begin{column}{0.6\linewidth}
\begin{center}
\includegraphics[max width=0.9\textwidth,max height=0.4\textheight]{{Images/the-rocky-horror-picture-show_5yC3RO}.jpg}
\end{center}
\end{column}
\end{columns}
\end{frame}
...
\begin{column}{0.6\linewidth}
\begin{center}
\includegraphics[max width=0.9\textwidth,max height=0.4\textheight]{{Images/joker-movie-joaquin-phoenix}.jpg}
\end{center}
\end{column}
\end{columns}
\end{frame}
...
\begin{column}{0.6\linewidth}
\begin{center}
\includegraphics[max width=0.9\textwidth,max height=0.4\textheight]{{Images/jessicarabbit}.jpg}
\end{center}
\end{column}
\end{columns}
\end{frame}
...
\begin{column}{0.6\linewidth}
\begin{center}
\includegraphics[max width=0.9\textwidth,max height=0.4\textheight]{{Images/littlemermaid}.jpeg}
\end{center}
\end{column}
\end{columns}
\end{frame}
...
\begin{column}{0.6\linewidth}
\begin{center}
\includegraphics[max width=0.9\textwidth,max height=0.4\textheight]{{Images/SPOTLIGHT-Keanu-Reeves-Speed}.jpg}
\end{center}
\end{column}
\end{columns}
\end{frame}
...
\begin{column}{0.6\linewidth}
\begin{center}
\includegraphics[max width=0.9\textwidth,max height=0.4\textheight]{{Images/rocky}.jpg}
\end{center}
\end{column}
\end{columns}
\end{frame}
...
\begin{column}{0.6\linewidth}
\begin{center}
\includegraphics[max width=0.9\textwidth,max height=0.4\textheight]{{Images/on-her-majestys-secret-service-us-one-sheet-poster}.jpg}
\end{center}
\end{column}
\end{columns}
\end{frame}
...
\begin{column}{0.6\linewidth}
\begin{center}
\includegraphics[max width=0.9\textwidth,max height=0.4\textheight]{{Images/avengers-endgame-poster-top-half}.jpg}
\end{center}
\end{column}
\end{columns}
\end{frame}
...
\begin{column}{0.6\linewidth}
\begin{center}
\includegraphics[max width=0.9\textwidth,max height=0.4\textheight]{{Images/pulp-fiction-red-apple}.jpg}
\end{center}
\end{column}
\end{columns}
\end{frame}
...
\begin{column}{0.6\linewidth}
\begin{center}
\includegraphics[max width=0.9\textwidth,max height=0.4\textheight]{{Images/meryl-streep-kramervskramer-1.jpg.html}.jpeg}
\end{center}
\end{column}
\end{columns}
\end{frame}

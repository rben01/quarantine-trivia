...
\visible<2->{
    ...
    \begin{column}{0.32\linewidth}
    \begin{block}{Answer}
    Cork (Republic of Ireland) or Belfast (all of Ireland)
    \end{block}
    \end{column}
    \begin{column}{0.65\linewidth}
    \begin{center}
...
\visible<2->{
    ...
    \begin{column}{0.32\linewidth}
    \begin{block}{Answer}
    A hangover / a severe headache accompanying a hangover / confusion and chaos
    \end{block}
    \end{column}
    \begin{column}{0.65\linewidth}
    \begin{center}
...
\vspace{-0.5em}
\begin{block}{Question}
Charles Darwin first noticed the adaptation of animals to different biological niches after observing the different beak shapes of what kind of birds?
\end{block}
\end{frame}
\subsection*{Q3}
...
\visible<2->{
    ...
    \begin{column}{0.32\linewidth}
    \begin{block}{Answer}
    Number One Observatory Circle / Admiral's House / Naval Observatory
    \end{block}
    \end{column}
    \begin{column}{0.65\linewidth}
    \begin{center}
...
\visible<2->{
    ...
    \begin{column}{0.32\linewidth}
    \begin{block}{Answer}
    The Tomb of the Unknown Soldier / Tomb of the Unknowns
    \end{block}
    \end{column}
    \begin{column}{0.65\linewidth}
    \begin{center}

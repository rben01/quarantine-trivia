...
class TriviaItem:
    ...
    def matches(
        self, template_type: Type[Union[_GenericTemplateGroup, _MatchableQuestionSlide]]
    ) -> bool:
    ...
    def get_q_and_a_frames(self) -> Tuple[BeamerFrame, BeamerFrame]:
        slide_type: Type[_GenericTemplateGroup] = LatexTemplates.Generic
    ...
    def get_approx_qanda_dims(
        ...
        return tuple(
            map(lambda t: TextDimInfo(t).approx_dims(), [self.question, self.answer])
        )

    ...
    \visible<2->{
        \begin{columns}[T,totalwidth=\linewidth]
            ...
            \begin{column}{0.65\linewidth}
                \begin{center}
                    \includegraphics[max width=0.95\textwidth,
                        max height=0.58000\textheight]{{Images/faa}.png}
                \end{center}
            \end{column}
        \end{columns}
    }
    ...
    \visible<2->{
        \begin{columns}[T,totalwidth=\linewidth]
            ...
            \begin{column}{0.65\linewidth}
                \begin{center}
                    \includegraphics[max width=0.95\textwidth,
                        max height=0.50000\textheight]{{Images/joinordie}.jpg}
                \end{center}
            \end{column}
        \end{columns}
    }
...
\begin{frame}[t]{Round 4 --- Famous ships and boats --- \mbox{Question 1}}
    \vspace{-0.5em}
    \begin{block}{Question}
        What was the designation (number) of the boat that was under the command of Navy Lt. JG John F.\@  Kennedy when it was rammed by a Japanese destroyer during WWII\@?
    \end{block}
\end{frame}
\subsection*{Q2}
\begin{frame}[t]{Round 4 --- Famous ships and boats --- \mbox{Question 2}}
    \vspace{-0.5em}
    \begin{block}{Question}
        What were the names of the Titanic's sister ships? (The name of one will do.)
    \end{block}
\end{frame}
\subsection*{Q3}
    ...
    \visible<2->{
        \begin{columns}[T,totalwidth=\linewidth]
            ...
            \begin{column}{0.65\linewidth}
                \begin{center}
                    \includegraphics[max width=0.95\textwidth,
                        max height=0.54000\textheight]{{Images/titanic}.jpg}
                \end{center}
            \end{column}
        \end{columns}
    }
...
\begin{frame}[t]{Round 4 --- Famous ships and boats --- \mbox{Answer 6}}
    ...
    \visible<2->{
        \begin{columns}[T,totalwidth=\linewidth]
            \begin{column}{0.32\linewidth}
                \begin{block}{Answer}
                    The Costa Concordia. (The ship was Italian and the captain was Francesco Schettino. The Italian Coast Guard radioed him to ``Get the f\textunderscore{}\textunderscore{}\textunderscore{}\textunderscore{}\textunderscore{} \textunderscore{}\textunderscore{}\textunderscore{}\textunderscore{}\textunderscore{}k on board'' (``Vada a bordo, cazzo!'') and these words came to mean in Italy ``Rally and do what you should do.'' Schettino ultimately went to prison.)
                \end{block}
            \end{column}
            \begin{column}{0.65\linewidth}
                \begin{center}
                    \includegraphics[max width=0.95\textwidth,
                        max height=0.46000\textheight]{{Images/costaconcordia}.jpg}
                \end{center}
            \end{column}
        \end{columns}
    }
    ...
    \visible<2->{
        \begin{columns}[T,totalwidth=\linewidth]
            ...
            \begin{column}{0.65\linewidth}
                \begin{center}
                    \includegraphics[max width=0.95\textwidth,
                        max height=0.50000\textheight]{{Images/berra}.jpg}
                \end{center}
            \end{column}
        \end{columns}
    }
    ...
    \visible<2->{
        \begin{columns}[T,totalwidth=\linewidth]
            ...
            \begin{column}{0.65\linewidth}
                \begin{center}
                    \includegraphics[max width=0.95\textwidth,
                        max height=0.38000\textheight]{{Images/custer}.jpg}
                \end{center}
            \end{column}
        \end{columns}
    }
...
\begin{frame}[t]{Round 9 --- Washington, D.C. --- \mbox{Question 1}}
    \vspace{-0.5em}
    \begin{block}{Question}
        To within three years, in what year was the 23\textsuperscript{rd} Amendment, which gave the citizens of D.\@C.\@ the right to vote in presidential elections, ratified?
    \end{block}
\end{frame}
\subsection*{Q2}
\begin{frame}[t]{Round 9 --- Washington, D.C. --- \mbox{Question 2}}
    \vspace{-0.5em}
    \begin{block}{Question}
        Referring to the fact that they have no representation in Congress, what slogan is on D.\@C.\@ license plates?
    \end{block}
\end{frame}
\subsection*{Q3}
...
\begin{frame}[t]{Round 10 --- Wonders of Engineering --- \mbox{Answer 6}}
    ...
    \visible<2->{
        \begin{columns}[T,totalwidth=\linewidth]
            \begin{column}{0.32\linewidth}
                \begin{block}{Answer}
                    2,722' / 830m (2472'--2972' / 754m--906m will be accepted)
                \end{block}
            \end{column}
            \begin{column}{0.65\linewidth}
                \begin{center}
    ...
    \visible<2->{
        \begin{columns}[T,totalwidth=\linewidth]
            ...
            \begin{column}{0.65\linewidth}
                \begin{center}
                    \includegraphics[max width=0.95\textwidth,
                        max height=0.46000\textheight]{{Images/iss}.jpg}
                \end{center}
            \end{column}
        \end{columns}
    }
...
\begin{frame}[t]{Bonus Round --- Foreign Words and Phrases}
    ...
    \visible<2->{
        \begin{block}{Answer}
            A novel in which the real people and events occur with invented names
        \end{block}
    }
\end{frame}
\begin{frame}[t]{Bonus Round --- Ireland}
...
\begin{frame}[t]{Bonus Round --- Wonders of Engineering}
    ...
    \visible<2->{
        \begin{block}{Answer}
            Any three of these: Channel Tunnel/Chunnel, CN Tower, Empire State Building, Golden Gate Bridge, Itaipú Dam, North Sea Protection Works/Delta/Zuiderzee, Panama Canal
        \end{block}
    }
\end{frame}
\section*{\ }

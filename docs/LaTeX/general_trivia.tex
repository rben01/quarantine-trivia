...
\vspace{-0.5em}
\begin{block}{Question}
In milk, fat globules are surrounded by protein membranes that keep the fat suspended in the water. What is the name of the mechanical process by which these membranes are broken, causing the milk's fats to separate from the water and clump together?
\end{block}
\end{frame}
\subsection{Answers}
...
\visible<2->{
    ...
    \begin{center}
    \includegraphics[max width=0.95\textwidth,
        max height=0.58000\textheight]{{Images/medvedev}.jpeg}
    \end{center}
    \end{column}
    \end{columns}
}
...
\visible<2->{
    ...
    \begin{column}{0.32\linewidth}
    \begin{block}{Answer}
    Aperture size or f-stop; shutter speed; and film speed  or ISO
    \end{block}
    \end{column}
    \begin{column}{0.65\linewidth}
    \begin{center}
    \includegraphics[max width=0.95\textwidth,
        max height=0.50000\textheight]{{Images/expostri}.jpg}
    \end{center}
    \end{column}
    \end{columns}
}
...
\visible<2->{
    ...
    \begin{column}{0.32\linewidth}
    \begin{block}{Answer}
    The Voice / Ole Blue Eyes / The Chairman of the Board
    \end{block}
    \end{column}
    \begin{column}{0.65\linewidth}
    \begin{center}

...
\visible<2->{
    ...
    \begin{center}
    \includegraphics[max width=0.95\textwidth,
        max height=0.50000\textheight]{{Images/arctic}.jpg}
    \end{center}
    \end{column}
    \end{columns}
}
...
\visible<2->{
    ...
    \begin{center}
    \includegraphics[max width=0.95\textwidth,
        max height=0.54000\textheight]{{Images/saffirsimpson}.png}
    \end{center}
    \end{column}
    \end{columns}
}
...
% \vspace{0.5em}
\begin{block}{Question}
In which national park can see you see the sunrise before anyone else in the U.S.?
\end{block}
\end{frame}
\subsection{Answers}
...
\visible<2->{
    ...
    \begin{center}
    \includegraphics[max width=0.95\textwidth,
        max height=0.54000\textheight]{{Images/hillsofrome}.png}
    \end{center}
    \end{column}
    \end{columns}
}
...
% \vspace{0.5em}
\begin{block}{Question}
What novel did Pres. Lincoln, among others, say contributed to starting the Civil War?
\end{block}
\end{frame}
\subsection*{Q2}
...
\visible<2->{
    ...
    \begin{column}{0.32\linewidth}
    \begin{block}{Answer}
    \emph{Uncle Tom's Cabin}, by Harriet Beecher Stowe (1852)
    \end{block}
    \end{column}
    \begin{column}{0.65\linewidth}
    \begin{center}
...
\visible<2->{
    ...
    \begin{column}{0.32\linewidth}
    \begin{block}{Answer}
    Synchronize timekeeping devices or keep clocks in sync
    \end{block}
    \end{column}
    \begin{column}{0.65\linewidth}
    \begin{center}
    \includegraphics[max width=0.95\textwidth,
        max height=0.34000\textheight]{{Images/clocksync}.jpg}
    \end{center}
    \end{column}
    \end{columns}
}
...
\visible<2->{
    ...
    \begin{column}{0.32\linewidth}
    \begin{block}{Answer}
    Oh, Kay! (Song by George and Ira Gershwin)
    \end{block}
    \end{column}
    \begin{column}{0.65\linewidth}
    \begin{center}

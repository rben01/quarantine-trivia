...
\begin{column}{0.65\linewidth}
\begin{center}
\includegraphics[max width=0.95\textwidth,max height=0.7\textheight]{{Images/paris2024bid}.png}
\end{center}
\end{column}
\end{columns}
\end{frame}
...
\begin{column}{0.65\linewidth}
\begin{center}
\includegraphics[max width=0.95\textwidth,max height=0.35\textheight]{{Images/paris2024bid}.png}
\end{center}
\end{column}
\end{columns}
...
\visible<2->{
    ...
    \begin{center}
    \includegraphics[max width=0.95\textwidth,
        max height=0.38\textheight]{{Images/paris2024official}.png}
    \end{center}
    \end{column}
    \end{columns}
}

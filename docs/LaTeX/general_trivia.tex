...
\visible<2->{
    ...
    \includegraphics[max width=0.95\textwidth,
        max height=0.54000\textheight]{{Images/riviera}.jpg}
    \end{center}
    \end{column}
    \end{columns}
}
...
\visible<2->{
    ...
    \begin{center}
    \includegraphics[max width=0.95\textwidth,
        max height=0.58000\textheight]{{Images/vjday}.jpg}
    \end{center}
    \end{column}
    \end{columns}
}
...
\end{frame}
\def\thisSectionName{Products By Their Slogans}
\section{Round 5}
\subsection*{Q1}
\begin{frame}[t]{Round 5 --- Products By Their Slogans --- \mbox{Question 1}}
% \vspace{0.5em}
\begin{block}{Question}
...
\end{frame}
\subsection*{Q2}
\begin{frame}[t]{Round 5 --- Products By Their Slogans --- \mbox{Question 2}}
% \vspace{0.5em}
\begin{block}{Question}
...
\end{frame}
\subsection*{Q3}
\begin{frame}[t]{Round 5 --- Products By Their Slogans --- \mbox{Question 3}}
% \vspace{0.5em}
\begin{block}{Question}
...
\end{frame}
\subsection{Answers}
\begin{frame}[t]{Round 5 --- Products By Their Slogans --- \mbox{Answer 1}}
% \vspace{0.5em}
\begin{block}{Question}
You're in good hands.
\end{block}
...
\end{frame}
\begin{frame}[t]{Round 5 --- Products By Their Slogans --- \mbox{Answer 2}}
% \vspace{0.5em}
\begin{block}{Question}
Tastes so good, cats ask for it by name.
\end{block}
...
\end{frame}
\begin{frame}[t]{Round 5 --- Products By Their Slogans --- \mbox{Answer 3}}
% \vspace{0.5em}
\begin{block}{Question}
Apply directly to the forehead.
\end{block}
...
\end{frame}
\begin{frame}[t]{Round 5 --- Products By Their Slogans --- \mbox{Answer 4}}
% \vspace{0.5em}
\begin{block}{Question}
The breakfast of champions.
\end{block}
...
\end{frame}
\begin{frame}[t]{Round 5 --- Products By Their Slogans --- \mbox{Answer 5}}
% \vspace{0.5em}
\begin{block}{Question}
The happiest place on Earth.
\end{block}
...
\visible<2->{
    ...
    \begin{column}{0.32\linewidth}
    \begin{block}{Answer}
    Disneyland (\emph{not} Disney World or Magic Kingdom)
    \end{block}
    \end{column}
    \begin{column}{0.65\linewidth}
    \begin{center}
...
\end{frame}
\begin{frame}[t]{Round 5 --- Products By Their Slogans --- \mbox{Answer 6}}
% \vspace{0.5em}
\begin{block}{Question}
Pizza pizza!
\end{block}
...
\end{frame}
\begin{frame}[t]{Round 5 --- Products By Their Slogans --- \mbox{Answer 7}}
% \vspace{0.5em}
\begin{block}{Question}
Once you pop, you can't stop.
\end{block}
...
\end{frame}
\begin{frame}[t]{Round 5 --- Products By Their Slogans --- \mbox{Answer 8}}
% \vspace{0.5em}
\begin{block}{Question}
Because you're worth it.
\end{block}
...
\end{frame}
\begin{frame}[t]{Round 5 --- Products By Their Slogans --- \mbox{Answer 9}}
% \vspace{0.5em}
\begin{block}{Question}
Quality never goes out of style.
\end{block}
...
\visible<2->{
    ...
    \begin{center}
    \includegraphics[max width=0.95\textwidth,
        max height=0.58000\textheight]{{Images/gotmilk}.jpg}
    \end{center}
    \end{column}
    \end{columns}
}
...
\end{frame}
\subsection{Answers}
\begin{frame}[t]{Round 10 --- Gangsters in Fact and Fiction --- \mbox{Answer 1}}
% \vspace{0.5em}
\begin{block}{Question}
Testifying before a Senate committee, what gangster said, ``No proof linking me to any criminal conspiracy, whether it is called `Mafia' or `Cosa Nostra' or whatever other name you wish to give,  has ever been made public''?
\end{block}
...
\end{frame}
\begin{frame}[t]{Round 10 --- Gangsters in Fact and Fiction --- \mbox{Answer 2}}
% \vspace{0.5em}
\begin{block}{Question}
What was the name of the movie in which the gangster's final words were the rhetorical question ``Mother of mercy, is this the end of Rico?''
\end{block}
...
\end{frame}
\begin{frame}[t]{Round 10 --- Gangsters in Fact and Fiction --- \mbox{Answer 3}}
% \vspace{0.5em}
\begin{block}{Question}
A gangster went to Umberto's Clam House in Little Italy on April 7, 1972 and died --- and it wasn't bad clams that got him.  Who was he?
\end{block}
...
\visible<2->{
    ...
    \begin{center}
    \includegraphics[max width=0.95\textwidth,
        max height=0.50000\textheight]{{Images/crazyjoe}.jpg}
    \end{center}
    \end{column}
    \end{columns}
}
\end{frame}
\begin{frame}[t]{Round 10 --- Gangsters in Fact and Fiction --- \mbox{Answer 4}}
% \vspace{0.5em}
\begin{block}{Question}
Dining out never seems to go well for gangsters. Which gangster proved on December 16, 1985 that New York City steaks are to die for ?
\end{block}
...
\end{frame}
\begin{frame}[t]{Round 10 --- Gangsters in Fact and Fiction --- \mbox{Answer 5}}
% \vspace{0.5em}
\begin{block}{Question}
Which gangster said ``Say hello to my little friend?''
\end{block}
...
\end{frame}
\begin{frame}[t]{Round 10 --- Gangsters in Fact and Fiction --- \mbox{Answer 6}}
% \vspace{0.5em}
\begin{columns}[T,totalwidth=\linewidth]
\begin{column}{0.32\linewidth}
\begin{block}{Question}
...
\end{frame}
\begin{frame}[t]{Round 10 --- Gangsters in Fact and Fiction --- \mbox{Answer 7}}
% \vspace{0.5em}
\begin{block}{Question}
In \emph{Goodfellas}, this gangster ended up in the witness protection program.
\end{block}
...
\end{frame}
\begin{frame}[t]{Round 10 --- Gangsters in Fact and Fiction --- \mbox{Answer 8}}
% \vspace{0.5em}
\begin{block}{Question}
In \emph{Godfather II}, the character of Hyman Roth is a stand-in for which real life gangster? 
\end{block}
...
\visible<2->{
    ...
    \begin{center}
    \includegraphics[max width=0.95\textwidth,
        max height=0.54000\textheight]{{Images/lansky}.jpg}
    \end{center}
    \end{column}
    \end{columns}
}
\end{frame}
\begin{frame}[t]{Round 10 --- Gangsters in Fact and Fiction --- \mbox{Answer 9}}
% \vspace{0.5em}
\begin{block}{Question}
This gangster, known as ``the Brain'', is believed to have been involved in fixing the 1919 World Series.
\end{block}
...
\end{frame}
\begin{frame}[t]{Round 10 --- Gangsters in Fact and Fiction --- \mbox{Answer 10}}
% \vspace{0.5em}
\begin{block}{Question}
This Gangster, who controlled Chicago crime during Prohibition, was ultimately sent to jail for tax evasion.
\end{block}

...
\end{{frame}}"""
        ...
        class Dinosaurs_Hunters(_MatchableQuestionSlide):
            SECTION = "Dinosaurs"
            NUMBER = 10
...
\end{{frame}}"""
        ...
        class Clothing_AoDai(_MatchableQuestionSlide):
            SECTION = "Clothing Around the World"
            NUMBER = 1
...
\end{{frame}}
        ...
        class Clothing_Ushanka(_MatchableQuestionSlide):
            SECTION = "Clothing Around the World"
            NUMBER = 4
...
\end{{frame}}
        ...
        class Clothing_Sarong(_MatchableQuestionSlide):
            SECTION = "Clothing Around the World"
            NUMBER = 9
...
\end{{frame}}
        ...
        class Clothing_Ciocia(_MatchableQuestionSlide):
            SECTION = "Clothing Around the World"
            NUMBER = 8
